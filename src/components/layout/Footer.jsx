        ...
        <div className="py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1">
              <h3 className="text-2xl font-bold text-primary-600 mb-4">Madomi</h3>
              <p className="text-gray-300 mb-6 leading-relaxed">
                Transformamos ideas en experiencias digitales excepcionales. 
                Somos tu socio estratégico para el éxito en el mundo digital.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a href="#servicios" className="text-gray-300 hover:text-primary-400 transition-colors duration-200">
                    Desarrollo Web
                  </a>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a href="#contacto" className="text-gray-300 hover:text-primary-400 transition-colors duration-200">
                    Contacto
                  </a>
                </li>
                <li>
