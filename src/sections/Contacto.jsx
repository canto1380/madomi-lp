      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-gray-800 rounded-2xl p-8">
            <div className="flex flex-col h-full">
              ...
              <div className="mt-6 text-center">
                <p className="text-gray-300 mb-2">📍 Madomi Pastas</p>
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-2xl font-bold mb-4 mt-8">Información de contacto</h3>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-green-400 rounded-lg flex items-center justify-center flex-shrink-0 border-2 border-white">
              ...
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-red-400 rounded-lg flex items-center justify-center flex-shrink-0  border-2 border-white">
